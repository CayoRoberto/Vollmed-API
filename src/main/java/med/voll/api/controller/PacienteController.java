...
import med.voll.api.domain.paciente.DadosDetalhmanetoPaciente;
...
public class PacienteController {
  ...
  public ResponseEntity cadastrar(@RequestBody @Valid DadosCadastroPaciente dados, UriComponentsBuilder uBuilder) {
    ...
    return ResponseEntity.created(uri).body(new DadosDetalhmanetoPaciente(paciente));
  }
  ...
  public ResponseEntity atualizar(@RequestBody @Valid DadosAtualizacaoPaciente dados) {
    ...
    return ResponseEntity.ok(new DadosDetalhmanetoPaciente(paciente));
  }
